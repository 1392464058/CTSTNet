...
def load_config(mode=None):
    ...
    parser.add_argument('--path', '--checkpoints', type=str, default='/mnt/data/wyn/sttc_xiu/Guided_Upsample/ckpt_zhuyilic',
                        help='model checkpoints path (default: ./checkpoints)')

    parser.add_argument('--model', type=int, default=2, choices=[1, 2, 3, 4],
                        help='1: edge model, 2: inpaint model, 3: edge-inpaint model, 4: joint model')

    parser.add_argument('--config_file', type=str, default='/mnt/data/wyn/sttc/Guided_Upsample/config_list/config_template.yml',
    ...
    # test mode
    if mode == 2:
        parser.add_argument('--input', type=str, default='/mnt/data/wyn/sttc/Guided_Upsample/testimage/image',
                            help='path to the input images directory or an input image')
        parser.add_argument('--mask', type=str, default='/mnt/data/wyn/sttc/Guided_Upsample/testimage/mask',
                            help='path to the masks directory or a mask file')


        parser.add_argument('--prior', type=str, default='/mnt/data/wyn/sttc/Guided_Upsample/testimage/structure',
                            help='path to the edges directory or an edge file')

        parser.add_argument('--output', type=str, default='./save2', help='path to the output directory')
